...
<div class="formularios">
    <h3><i class="glyphicon glyphicon-pencil"></i>Modificar Ficha</h3>
    <div class="col-md-5">
<form action="resultadoFormularioModificarFicha.php" method="post">
  <div class="form-group">
    <label for="fecha_proxima_revision">Fecha de la próxima revisión</label>
    <input type="text" class="form-control" name="fecha_proxima_revision" placeholder="dd/mm/aaaa">
  </div>
  <div class="form-group">
