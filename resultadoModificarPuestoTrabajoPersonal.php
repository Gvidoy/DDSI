...
if(isset($_POST['Consultar'])){
	...
	$sql = "UPDATE Personal SET puesto_trabajo = '$puesto_trabajo' where dni = '$dni'";

    if(mysqli_query($conn,$sql)){
        echo "<br><div class='alert alert-success' role='alert'>Puesto de trabajo añadido correctamente</div>";
    }else{
